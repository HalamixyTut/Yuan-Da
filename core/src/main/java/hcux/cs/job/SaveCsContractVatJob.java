...
public class SaveCsContractVatJob extends AbstractJob {
    @Autowired
    private ICsContractVatService iCsContractVatService;
    ...
    public void safeExecute(JobExecutionContext jobExecutionContext) throws Exception {
        ...
        try {
            SysJobRecord record = new SysJobRecord(SysConstant.JOB_CODE.HCUX_CS_CONTRACT_VAT);
            record = sysJobRecordMapper.selectOne(record);
            if (record == null) {
                record = new SysJobRecord();
                record.setJobCode(SysConstant.JOB_CODE.HCUX_CS_CONTRACT_VAT);
