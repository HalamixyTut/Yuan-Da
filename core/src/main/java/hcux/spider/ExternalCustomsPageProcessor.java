 ...
 * 异地报关页面爬虫
 */
public class ExternalCustomsPageProcessor implements PageProcessor {
    ...
    public void start() {
        Request request = new Request(loginUrlPrefix + externalCustomsUrl);
...
//        ExternalCustomsPageProcessor processor = new ExternalCustomsPageProcessor();
//        processor.setEpsCustomsDetailList(customsPageList);
//        processor.setContractNumber("2");
//        processor.start();
//    }

    private Request getRequest(String page, String viewState, String eventValidation) {
        Request request = new Request(externalCustomsUrl + "?page=" + page);
