...
public class SaveGeneralLedgerJob extends AbstractJob {
    @Autowired
    private IEpsGeneralLedgerService iEpsGeneralLedgerService;
    ...
    public void safeExecute(JobExecutionContext jobExecutionContext) throws Exception {
        ...
        try {
            count = iEpsGeneralLedgerService.epsGeneralLedgerToHap(iRequest);
        } catch (Exception e) {
            //获取类名
            String className=SaveGeneralLedgerJob.class.getName();
            //获取错误信息
